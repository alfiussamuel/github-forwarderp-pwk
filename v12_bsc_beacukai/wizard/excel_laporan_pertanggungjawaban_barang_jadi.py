...
class ReportBarangjadi(models.AbstractModel):
    _name = 'report.v12_bsc_beacukai.report_barangjadi'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('v12_bsc_beacukai.report_barangjadi', docargs)
...
class ExcelLaporanPertanggungjawaban_barang_jadi(models.TransientModel):
    ...
    def generate_preview(self):
        ...
        if mutasi_ids:
            ...
            action = self.env['ir.model.data'].xmlid_to_object('v12_bsc_beacukai.action_laporan_mutasi_barang_jadi')
            if not action:
                action = {
                    'view_type': 'form',
                    'view_mode': 'tree',
    ...
    def _print_report(self, data):
        ...
        return self.env['report'].get_action(self, 'v12_bsc_beacukai.report_barangjadi', data=data)
    ...
    def generate_report(self):
        ...
        form_res = ir_model_data.get_object_reference(
            'v12_bsc_beacukai', 'excel_laporan_pertanggungjawaban_barang_jadi_form')
