...
class PwkMutasiVeneerOkRepairLine(models.Model):
...
class PwkMutasiVeneerOkRepair(models.Model):    
    ...
    line_ids = fields.One2many('pwk.mutasi.veneer.ok.repair.line', 'reference', string="OK Repair", track_visibility="always")
