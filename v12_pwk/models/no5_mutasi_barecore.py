...
class PwkMutasiVeneerBarecoreLine(models.Model):
    _name = "pwk.mutasi.barecore.line"
    ...
    def _get_acc(self):
        for res in self:
            ...
            source_ids = self.env['pwk.mutasi.barecore.line'].search([
...
class PwkMutasiBarecore(models.Model):    
    ...
    line_ids = fields.One2many('pwk.mutasi.barecore.line', 'reference', string="Barecore", track_visibility="always")
