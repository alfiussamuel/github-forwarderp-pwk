        ...
        for res in self:
            ...
            if res.line_ids:
                for line in res.line_ids:
                    new_product_name = 'Veneer Kering ' + line.product_id.jenis_kayu.name + '  ' + line.product_id.tebal + ' x ' + line.product_id.lebar + ' x ' + line.product_id.panjang + ' Grade ' + line.product_id.grade.name.name
