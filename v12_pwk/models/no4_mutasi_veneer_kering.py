        ...
        for res in self:
            ...
            if res.line_ids:
                for line in res.line_ids:
                    new_product_name = 'Veneer Kering ' + line.product_id.jenis_kayu.name + '  ' + str(line.product_id.tebal) + ' x ' + str(line.product_id.lebar) + ' x ' + str(line.product_id.panjang) + ' Grade ' + line.product_id.grade.name
