...
class PwkPermakaianVeneerGsLine(models.Model):
...
class PwkPemakaianVeneerGs(models.Model):    
    ...
    line_ids = fields.One2many('pwk.pemakaian.veneer.gs.line', 'reference', string="Lines", track_visibility="always")
    ...
    def create(self, vals):
        vals['name'] = self.get_sequence('Pemakaian Veneer Glue Spreader', 'pwk.pemakaian.veneer.gs')
