...
class PwkMutasiVeneerBasahStacking(models.Model):    
    ...
    acc_stock_masuk_supplier_vol = fields.Float(compute="_get_volume", string='Stok Masuk Supplier')
    ...
    acc_stock_masuk_rotary_vol = fields.Float(compute="_get_volume", string='Stock Masuk Rotary')
    ...
    acc_stock_keluar_stacking_vol = fields.Float(compute="_get_volume", string='Stok Keluar Stacking')
    ...
    acc_stock_keluar_roler_vol = fields.Float(compute="_get_volume", string='Stok Keluar Roler')
