...
class PwkMutasiVeneerBasahKd(models.Model):    
    ...
    acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Stok Masuk (M3)', digits=dp.get_precision('FourDecimal'))    
    ...
    acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Stok Keluar (M3)', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiVeneerBasahStacking(models.Model):    
    ...
    acc_stock_masuk_supplier_vol = fields.Float(compute="_get_volume", string='Stok Masuk Supplier (M3)', digits=dp.get_precision('FourDecimal'))
    ...
    acc_stock_keluar_stacking_vol = fields.Float(compute="_get_volume", string='Stok Keluar Stacking (M3)', digits=dp.get_precision('FourDecimal'))
    stock_keluar_roler_pcs = fields.Float('Stok Keluar Roler')    
    stock_keluar_roler_vol = fields.Float(compute="_get_volume", string='Stok Keluar Roler (M3)', digits=dp.get_precision('FourDecimal'))
    acc_stock_keluar_roler_pcs = fields.Float(compute="_get_acc", string='Stok Keluar Roler')
    acc_stock_keluar_roler_vol = fields.Float(compute="_get_volume", string='Stok Keluar Roler (M3)', digits=dp.get_precision('FourDecimal'))
    stock_akhir_pcs = fields.Float(compute="_get_stock_akhir", string='Stok Akhir')
    stock_akhir_vol = fields.Float(compute="_get_volume", string='Stok Akhir (M3)', digits=dp.get_precision('FourDecimal'))
