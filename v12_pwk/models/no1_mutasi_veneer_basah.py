...
class PwkMutasiVeneerBasahKd(models.Model):    
    ...
    stock_awal_vol = fields.Float(compute="_get_volume", string='Stok Awal (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_masuk_pcs = fields.Float(compute="_get_stock_masuk", string='Stok Masuk')    
    stock_masuk_vol = fields.Float(compute="_get_volume", string='Stok Masuk (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Stok Masuk')
    acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Stok Masuk (Vol)', digits=dp.get_precision('FourDecimal'))    
    stock_keluar_pcs = fields.Float('Stok Keluar')    
    stock_keluar_vol = fields.Float(compute="_get_volume", string='Stok Keluar (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Stok Keluar')
    acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Stok Keluar (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_akhir_pcs = fields.Float(compute="_get_stock_akhir", string='Stok Akhir')
    stock_akhir_vol = fields.Float(compute="_get_volume", string='Stok Akhir (Vol)', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiVeneerBasahStacking(models.Model):    
    ...
    stock_masuk_supplier_vol = fields.Float(compute="_get_volume", string='Stok Masuk Supplier (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_masuk_supplier_pcs = fields.Float(compute="_get_acc", string='Stok Masuk Supplier')
    acc_stock_masuk_supplier_vol = fields.Float(compute="_get_volume", string='Stok Masuk Supplier (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_masuk_rotary_pcs = fields.Float('Stok Masuk Rotary')    
    stock_masuk_rotary_vol = fields.Float(compute="_get_volume", string='Stok Masuk Rotary (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_masuk_rotary_pcs = fields.Float(compute="_get_acc", string='Stock Masuk Rotary')
    acc_stock_masuk_rotary_vol = fields.Float(compute="_get_volume", string='Stock Masuk Rotary (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_keluar_stacking_pcs = fields.Float('Stok Keluar Stacking')    
    stock_keluar_stacking_vol = fields.Float(compute="_get_volume", string='Stok Keluar Stacking (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_keluar_stacking_pcs = fields.Float(compute="_get_acc", string='Stok Keluar Stacking')
    acc_stock_keluar_stacking_vol = fields.Float(compute="_get_volume", string='Stok Keluar Stacking (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_keluar_roler_pcs = fields.Float('Stok Keluar Roler')    
    stock_keluar_roler_vol = fields.Float(compute="_get_volume", string='Stok Keluar Roler (Vol)', digits=dp.get_precision('FourDecimal'))
    acc_stock_keluar_roler_pcs = fields.Float(compute="_get_acc", string='Stok Keluar Roler')
    acc_stock_keluar_roler_vol = fields.Float(compute="_get_volume", string='Stok Keluar Roler (Vol)', digits=dp.get_precision('FourDecimal'))
    stock_akhir_pcs = fields.Float(compute="_get_stock_akhir", string='Stok Akhir')
    stock_akhir_vol = fields.Float(compute="_get_volume", string='Stok Akhir (Vol)', digits=dp.get_precision('FourDecimal'))
