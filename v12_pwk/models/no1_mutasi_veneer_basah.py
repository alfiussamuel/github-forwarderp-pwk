...
class PwkMutasiVeneerBasahStacking(models.Model):    
    ...
    stock_masuk_supplier_vol = fields.Float(compute="_get_volume", string='Stok Masuk Supplier', digits=dp.get_precision('FourDecimal'))
    ...
    stock_masuk_rotary_vol = fields.Float(compute="_get_volume", string='Stok Masuk Rotary', digits=dp.get_precision('FourDecimal'))
    acc_stock_masuk_rotary_pcs = fields.Float(compute="_get_acc", string='Stock Masuk Rotary')
    acc_stock_masuk_rotary_vol = fields.Float(compute="_get_volume", string='Stock Masuk Rotary', digits=dp.get_precision('FourDecimal'))
    stock_keluar_stacking_pcs = fields.Float('Stok Keluar Stacking')    
    stock_keluar_stacking_vol = fields.Float(compute="_get_volume", string='Stok Keluar Stacking', digits=dp.get_precision('FourDecimal'))
