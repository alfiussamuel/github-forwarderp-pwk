...
class PwkMutasiAssemblingFinishingGs1(models.Model):
    ...
    gs_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk GS')
    gs_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk GS', digits=dp.get_precision('FourDecimal'))

    re_stock_masuk_pcs = fields.Float(compute="_get_stock_masuk", string='Masuk Re-GS (Pcs)')
    re_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Re-GS (M3)', digits=dp.get_precision('FourDecimal'))
    re_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Re-GS')
    re_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Re-GS', digits=dp.get_precision('FourDecimal'))
    
    hot_stock_keluar_pcs = fields.Float('Keluar Hot (Pcs)')
    hot_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Hot (M3)', digits=dp.get_precision('FourDecimal'))
    hot_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Hot')
    hot_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Hot', digits=dp.get_precision('FourDecimal'))

    gs_stock_keluar_pcs = fields.Float('Keluar GS (Pcs)')
    gs_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar GS (M3)', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingGs2(models.Model):
    ...
    sk_stock_keluar_pcs = fields.Float('Keluar SK (Pcs)')
    sk_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar SK (M3)', digits=dp.get_precision('FourDecimal'))
    sk_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar SK')
    sk_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar SK', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingUnsander(models.Model):
    ...
    hot_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Hot')
    hot_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Hot', digits=dp.get_precision('FourDecimal'))

    re_stock_masuk_pcs = fields.Float(compute="_get_stock_masuk", string='Masuk Re (Pcs)')
    re_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Re (M3)', digits=dp.get_precision('FourDecimal'))
    re_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Re')
    re_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Re', digits=dp.get_precision('FourDecimal'))
    
    sander_stock_keluar_pcs = fields.Float('Keluar Sander (Pcs)')
    sander_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sander (M3)', digits=dp.get_precision('FourDecimal'))
    sander_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Sander')
    sander_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sander', digits=dp.get_precision('FourDecimal'))

    reproses_stock_keluar_pcs = fields.Float('Keluar Reproses (Pcs)')
    reproses_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Reproses (M3)', digits=dp.get_precision('FourDecimal'))
    reproses_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Reproses')
    reproses_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Reproses', digits=dp.get_precision('FourDecimal'))

    qc_stock_keluar_pcs = fields.Float('Keluar QC')
    qc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar QC', digits=dp.get_precision('FourDecimal'))
    qc_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar QC')
    qc_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar QC', digits=dp.get_precision('FourDecimal'))

    lain_stock_keluar_pcs = fields.Float('Keluar Lain (Pcs)')
    lain_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Lain (M3)', digits=dp.get_precision('FourDecimal'))
    lain_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Lain')
    lain_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Lain', digits=dp.get_precision('FourDecimal'))

    re_stock_keluar_pcs = fields.Float('Keluar Re (Pcs)')
    re_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Re (M3)', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingProses1(models.Model):
    ...
    sander_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Sander')
    sander_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Sander', digits=dp.get_precision('FourDecimal'))
    ...
    lup1_sander_stock_keluar_pcs = fields.Float('Keluar LUP1 (Pcs)')
    lup1_sander_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar LUP1 (M3)', digits=dp.get_precision('FourDecimal'))
    lup1_sander_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar LUP1')
    lup1_sander_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar LUP1', digits=dp.get_precision('FourDecimal'))

    lup2_sander_stock_keluar_pcs = fields.Float('Keluar LUP2 (Pcs)')
    lup2_sander_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar LUP2 (M3)', digits=dp.get_precision('FourDecimal'))
    lup2_sander_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar LUP2')
    lup2_sander_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar LUP2', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingKalibrasi(models.Model):
    ...
    sander2_stock_keluar_pcs = fields.Float('Keluar Sander2 (Pcs)')
    sander2_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sander2 (M3)', digits=dp.get_precision('FourDecimal'))
    sander2_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Sander2')
    sander2_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sander2', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingKalibrasi2(models.Model):
    ...
    sizer_stock_keluar_pcs = fields.Float('Keluar Sizer (Pcs)')
    sizer_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sizer (M3)', digits=dp.get_precision('FourDecimal'))
    sizer_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Sizer')
    sizer_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Sizer', digits=dp.get_precision('FourDecimal'))
    
    tipis_stock_keluar_pcs = fields.Float('Keluar Tipis (Pcs)')
    tipis_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Tipis (M3)', digits=dp.get_precision('FourDecimal'))
    tipis_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Tipis')
    tipis_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Tipis', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingSizer(models.Model):
    ...
    sander2_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Sander2')
    sander2_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Sander2', digits=dp.get_precision('FourDecimal'))

    manual_stock_masuk_pcs = fields.Float(compute="_get_stock_masuk", string='Masuk Manual (Pcs)')
    manual_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Manual (M3)', digits=dp.get_precision('FourDecimal'))
    manual_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Manual')
    manual_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Manual', digits=dp.get_precision('FourDecimal'))
    ...
    grading_stock_keluar_pcs = fields.Float('Keluar Grading (Pcs)')
    grading_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Grading (M3)', digits=dp.get_precision('FourDecimal'))
    grading_acc_stock_keluar_pcs = fields.Float(compute="_get_acc", string='Keluar Grading')
    grading_acc_stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar Grading', digits=dp.get_precision('FourDecimal'))
...
class PwkMutasiAssemblingFinishingFinish(models.Model):
    ...
    sizer_acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk Sizer')
    sizer_acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk Sizer', digits=dp.get_precision('FourDecimal'))
    ...
    @api.depends('stock_awal_pcs',
        'sizer_stock_masuk_pcs','sizer_acc_stock_masuk_pcs',
        're_stock_masuk_pcs','re_acc_stock_masuk_pcs',
        'grading_stock_keluar_pcs','grading_acc_stock_keluar_pcs',
        'lain_stock_keluar_pcs','lain_acc_stock_keluar_pcs',
        're_stock_keluar_pcs','re_acc_stock_keluar_pcs',
    ...
    def _get_stock_akhir(self):
        for res in self:
            res.stock_akhir_pcs = res.stock_awal_pcs + res.sizer_stock_masuk_pcs + res.re_stock_masuk_pcs- res.grading_stock_keluar_pcs - res.lain_stock_keluar_pcs - res.qc_stock_keluar_pcs - res.re_stock_keluar_pcs
...
class PwkMutasiAssemblingFinishingReproses(models.Model):
    ...
    acc_stock_masuk_pcs = fields.Float(compute="_get_acc", string='Masuk')
    acc_stock_masuk_vol = fields.Float(compute="_get_volume", string='Masuk', digits=dp.get_precision('FourDecimal'))
    
    stock_keluar_pcs = fields.Float('Keluar Grading (Pcs)')
    stock_keluar_vol = fields.Float(compute="_get_volume", string='Keluar (M3)', digits=dp.get_precision('FourDecimal'))
